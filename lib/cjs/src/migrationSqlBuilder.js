...
exports.createMigration = exports.alterTable = exports.createTable = exports.createTableIfNotExist = exports.MigrationCommand = exports.KeyDefinition = exports.ColumnDefinition = exports.CURRENT_DATE = void 0;
const baseClass_1 = __importDefault(require("./baseClass"));
exports.CURRENT_DATE = 'NOW';
class ColumnDefinition extends baseClass_1.default {
...
class MigrationCommand extends baseClass_1.default {
...
function createMigration(type, table) {
