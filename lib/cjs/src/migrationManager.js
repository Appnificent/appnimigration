...
class MigrationManager {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let migrationFile of migrations) {
                if (migratedFiles.includes(migrationFile))
                    continue;
                const migration = require((0, path_1.join)((0, path_1.resolve)(this._dir), migrationFile)).default;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (latestMigrations[0].Name !== 'init.ts') {
                for (let migration of latestMigrations) {
                    const migrationModel = require((0, path_1.join)((0, path_1.resolve)(this._dir), migration.Name)).default;
    ...
    generate(name, template = 'migration-template.ts', init = false) {
        ...
        const templateFull = (0, fs_1.readFileSync)((0, path_1.join)(__dirname, template), { encoding: 'utf8' });
        (0, fs_1.writeFileSync)((0, path_1.join)((0, path_1.resolve)(this._dir), fileName + '.ts'), templateFull);
    }
    generateName(name) {
        const now = new Date();
    ...
    loadCfgFile() {
        ...
        const cfg = require((0, path_1.join)(process.cwd(), 'appnimigration.config.js'));
        if (!cfg) {
